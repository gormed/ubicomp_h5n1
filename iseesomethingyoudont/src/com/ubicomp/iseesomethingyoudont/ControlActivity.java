...
public class ControlActivity extends Activity implements OnTouchListener, OnInitListener{
    ...
    // Kompressionsmodul K - er beschreibt, welche allseitige Druck�nderung n�tig ist, 
	...
	public void onPause(){
		super.onPause();//
		// Wenn man den kill au�erhalb des if macht, wird die app sofort bei start gekillt
